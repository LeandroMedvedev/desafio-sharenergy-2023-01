...
var listUsersService = function (_a) {
    var username = _a.username;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, serialized_1, users, serialized;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, schemas_1.serializedUserSchema.validate(user, {
                            stripUnknown: true,
                        })];
                case 2:
                    serialized_1 = _b.sent();
                    return [2 /*return*/, { status: 200, message: serialized_1 }];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.all(users.map(function (user) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, schemas_1.serializedUserSchema.validate(user, { stripUnknown: true })];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        }); }); }))];
                case 5:
                    serialized = _b.sent();
                    return [2 /*return*/, { status: 200, message: serialized }];
            }
        });
    });
};
